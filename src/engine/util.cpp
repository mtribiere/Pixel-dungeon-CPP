...
std::vector<bool> BArray::myNot(std::vector<bool>&a, std::vector<bool>& result)
{
	int length = a.size();
...
std::vector<bool> BArray::myOr(std::vector<bool>& a, std::vector<bool>& b, std::vector<bool>& result)
{
	int length = a.size();
...
std::vector<int> Ballistica::trace(std::max(32, 32));
