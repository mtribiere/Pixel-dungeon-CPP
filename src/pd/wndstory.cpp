...
void WndStory::initChapters()
{
	if (CHAPTERS.size() <= 0)
	{
		CHAPTERS.insert(std::make_pair(0, BPT::getText("lang.wndstory_sewers")));
		CHAPTERS.insert(std::make_pair(1, BPT::getText("lang.wndstory_prison")));
		CHAPTERS.insert(std::make_pair(2, BPT::getText("lang.wndstory_caves")));
		CHAPTERS.insert(std::make_pair(3, BPT::getText("lang.wndstory_metropolis")));
		CHAPTERS.insert(std::make_pair(4, BPT::getText("lang.wndstory_halls")));
	}
}
